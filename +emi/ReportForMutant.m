classdef ReportForMutant < handle
    ...
    methods
        function obj = ReportForMutant( my_id, original_sys, exp_data,...
            ...
            % 新僵尸块
            obj.new_zombile_blocks = newZombieBlock;
            ...
            % 新僵尸块跳过第一个
            obj.new_zombile_blocks_to_annotate = new_blocks{2:end,1};
            obj.newzombile_mutant = cps.SlsfModel(...
                obj.get_mutant_name(),...
                obj.base_dir_for_this_model,...
                new_blocks, compiled_types, exit_after_pp...
            );  
