classdef cfg
    ...
    properties(Constant = true)
        ...
        % 变体策略 1.Subsystem 2.Recover 3.Subsystem & Recover
        DECSTYPE = 2;
        % 采样方式 1.Library  2.System   3.DB
        SAMPLETYPE = 3;
        % Subsystem方法是否连接到主线路上
        IFCONNECTLINE = false;
        ...
        MUTATOR_DECORATORS = {
            ...
            @emi.decs.DataRecoverBlockStrategy                 % 子系统与恢复策略
            % @emi.decs.DeadZoneAddBlock                         % 死区添加块
           %  @emi.decs.DeadSignalStrategy % 纯死区变异
            %             @emi.decs.DeleteDeadAddSaturation                           % Dead Mutation
            %             @emi.decs.LiveMutation                                      % Live Mutation
            %             @emi.decs.NewZombieBlockStrategy                            % 新僵尸突变
            };
        ...
        WS_FILE_NAME_ = 'savedwsOjiken.mat';
