...
%          DO_THESE_EXPERIMENTS = [1 2 9 8 3 4 5 6 7]; % Multiple experiments
         DO_THESE_EXPERIMENTS = [1 2 8 3]; % Multiple experiments
%        DO_THESE_EXPERIMENTS = 5;   % Single experiment
        
        %% Others
        
        SIMULATION_TIMEOUT = 100;   % seconds
...
%             {difftest.ec.solver_var, difftest.ec.solver_fix}
        ...
        SIMULATION_ARGS = struct('ReturnWorkspaceOutputs','on','UnconnectedOutputMsg', 'none',...
